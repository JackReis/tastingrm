...
SetWidgetRichText('u55', '<p style="text-align:left;line-height:27px;"><span style="font-family:Helvetica Neue;font-size:24px;font-weight:normal;font-style:normal;text-decoration:none;color:#666666;">You have ' + (GetGlobalVariableValue('ItemsInCart')) + ' items in your shopping cart.</span></p>');

}

});
gv_vAlignTable['u50'] = 'center';gv_vAlignTable['u51'] = 'top';gv_vAlignTable['u54'] = 'center';gv_vAlignTable['u55'] = 'top';gv_vAlignTable['u21'] = 'top';$('#u22').attr('axSubmit', 'u15');
...
SetGlobalVariableValue('LoginState', 'Guest');
	...
	self.location.href=$axure.globalVariableProvider.getLinkUrl('3__Upsell_page.html');
...
function waitu6b240363903e435588d74b1bf176c2521() {

	self.location.href=$axure.globalVariableProvider.getLinkUrl('3__Upsell_page.html');
}
setTimeout(waitu6b240363903e435588d74b1bf176c2521, 5000);

}
});
gv_vAlignTable['u39'] = 'center';gv_vAlignTable['u1'] = 'top';gv_vAlignTable['u3'] = 'top';gv_vAlignTable['u4'] = 'top';gv_vAlignTable['u41'] = 'top';gv_vAlignTable['u42'] = 'top';gv_vAlignTable['u40'] = 'top';document.getElementById('u45_img').tabIndex = 0;
HookHover('u45', false);
HookClick('u45', false);
