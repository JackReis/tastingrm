...
SetWidgetRichText('u50', '<p style="text-align:left;line-height:27px;"><span style="font-family:Helvetica Neue;font-size:24px;font-weight:normal;font-style:normal;text-decoration:none;color:#666666;">You have ' + (GetGlobalVariableValue('ItemsInCart')) + ' items in your shopping cart.</span></p>');
...
gv_vAlignTable['u50'] = 'top';gv_vAlignTable['u20'] = 'top';document.getElementById('u21_img').tabIndex = 0;
HookHover('u21', false);
HookClick('u21', false);
...
gv_vAlignTable['u4'] = 'center';gv_vAlignTable['u41'] = 'center';document.getElementById('u42_img').tabIndex = 0;
HookHover('u42', false);
HookClick('u42', false);
...
gv_vAlignTable['u45'] = 'center';gv_vAlignTable['u46'] = 'top';gv_vAlignTable['u43'] = 'center';gv_vAlignTable['u7'] = 'top';gv_vAlignTable['u8'] = 'top';gv_vAlignTable['u9'] = 'top';gv_vAlignTable['u49'] = 'center';document.getElementById('u10_img').tabIndex = 0;
HookHover('u10', false);
HookClick('u10', false);
