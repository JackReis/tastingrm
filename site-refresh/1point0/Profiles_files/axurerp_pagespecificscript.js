...
gv_vAlignTable['u81'] = 'center';gv_vAlignTable['u83'] = 'center';gv_vAlignTable['u85'] = 'center';gv_vAlignTable['u87'] = 'center';gv_vAlignTable['u89'] = 'center';gv_vAlignTable['u91'] = 'center';document.getElementById('u92_img').tabIndex = 0;
HookHover('u92', false);
...
gv_vAlignTable['u111'] = 'top';gv_vAlignTable['u20'] = 'center';document.getElementById('u21_img').tabIndex = 0;
HookHover('u21', false);
...
gv_vAlignTable['u109'] = 'top';document.getElementById('u31_img').tabIndex = 0;
HookHover('u31', false);
...
gv_vAlignTable['u38'] = 'center';gv_vAlignTable['u93'] = 'top';document.getElementById('u94_img').tabIndex = 0;
HookHover('u94', false);
...
gv_vAlignTable['u99'] = 'top';gv_vAlignTable['u40'] = 'top';gv_vAlignTable['u41'] = 'top';gv_vAlignTable['u42'] = 'top';
$axure.eventManager.mouseout('u45', function(e) {
if (!IsTrueMouseOut('u45',e)) return;
if (true) {

	SetPanelState('u44', 'pd0u44','fade','',500,'swing','left',500);
...
gv_vAlignTable['u49'] = 'center';gv_vAlignTable['u1'] = 'center';document.getElementById('u5_img').tabIndex = 0;
HookHover('u5', false);
...
gv_vAlignTable['u6'] = 'top';gv_vAlignTable['u8'] = 'top';document.getElementById('u9_img').tabIndex = 0;
HookHover('u9', false);
...
if (true) {
	...
	SetPanelState('u44', 'pd1u44','none','',500,'swing','right',500);
...
if (true) {
	...
	SetPanelState('u44', 'pd1u44','swing','right',500,'swing','right',500);
...
if (true) {
	...
	SetPanelState('u44', 'pd1u44','fade','',500,'swing','right',500);
