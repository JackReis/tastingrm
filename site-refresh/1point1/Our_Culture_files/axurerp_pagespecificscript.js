...
gv_vAlignTable['u101'] = 'top';HookHover('u102', false);
...
if (true) {
	...
	SetPanelState('u37', 'pd0u37','fade','',500,'swing','left',500);

}
});
gv_vAlignTable['u39'] = 'center';gv_vAlignTable['u93'] = 'top';document.getElementById('u94_img').tabIndex = 0;
HookHover('u94', false);
...
if (true) {
	...
	SetPanelState('u37', 'pd1u37','none','',500,'swing','right',500);
...
if (true) {
	...
	SetPanelState('u37', 'pd1u37','swing','right',500,'swing','right',500);
...
if (true) {
	...
	SetPanelState('u37', 'pd1u37','fade','',500,'swing','right',500);

}
});
gv_vAlignTable['u46'] = 'center';gv_vAlignTable['u48'] = 'top';gv_vAlignTable['u49'] = 'top';document.getElementById('u2_img').tabIndex = 0;
HookHover('u2', false);
...
gv_vAlignTable['u7'] = 'top';gv_vAlignTable['u50'] = 'top';document.getElementById('u52_img').tabIndex = 0;
