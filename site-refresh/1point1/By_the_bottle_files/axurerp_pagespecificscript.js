...
gv_vAlignTable['u89'] = 'top';gv_vAlignTable['u91'] = 'top';document.getElementById('u92_img').tabIndex = 0;
HookHover('u92', false);
...
if (true) {
	...
	self.location.href=$axure.globalVariableProvider.getLinkUrl('Red_1.html');

}
});
gv_vAlignTable['u10'] = 'top';document.getElementById('u13_img').tabIndex = 0;
HookHover('u13', false);
...
gv_vAlignTable['u113'] = 'top';document.getElementById('u114_img').tabIndex = 0;
...
gv_vAlignTable['u115'] = 'top';gv_vAlignTable['u20'] = 'center';document.getElementById('u23_img').tabIndex = 0;
HookHover('u23', false);
...
if (true) {
	...
	self.location.href=$axure.globalVariableProvider.getLinkUrl('Sparkling_1.html');
...
gv_vAlignTable['u103'] = 'top';document.getElementById('u104_img').tabIndex = 0;
...
gv_vAlignTable['u109'] = 'top';gv_vAlignTable['u30'] = 'top';gv_vAlignTable['u32'] = 'top';gv_vAlignTable['u33'] = 'top';gv_vAlignTable['u34'] = 'top';
...
if (true) {
	...
	self.location.href=$axure.globalVariableProvider.getLinkUrl('White_1.html');
...
if (true) {
	...
	self.location.href=$axure.globalVariableProvider.getLinkUrl('Rose_1.html');
...
if (true) {
	...
	self.location.href=$axure.globalVariableProvider.getLinkUrl('Dessert_1.html');

}
});
gv_vAlignTable['u99'] = 'top';document.getElementById('u116_img').tabIndex = 0;
...
gv_vAlignTable['u125'] = 'top';document.getElementById('u0_img').tabIndex = 0;
