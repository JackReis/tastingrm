...
var PageName = 'Wine Finder';
var PageId = 'b18eb2690a78419897787278a04f0530'
var PageUrl = 'Wine_Finder.html'
document.title = 'Wine Finder';
var PageNotes = 
{
...
if (true) {
	...
	self.location.href="Party_Planner.html" + GetQuerystring();
...
if (bIE) u55.attachEvent("onfocus", Focusu55);
else u55.addEventListener("focus", Focusu55, true);
function Focusu55(e)
{
windowEvent = e;


if ((GetWidgetFormText('u55')) == ('Search')) {
...
if (bIE) u55.attachEvent("onblur", LostFocusu55);
else u55.addEventListener("blur", LostFocusu55, true);
function LostFocusu55(e)
{
windowEvent = e;


if ((GetWidgetFormText('u55')) == ('')) {
